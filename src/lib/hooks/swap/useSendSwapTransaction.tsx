...
import { AnyTrade, SwapCall, SwapCallAsync } from '../../../hooks/useSwapCallArguments'
...
export default function useSendSwapTransaction(
  ...
  swapCallsMaybeAsync: (SwapCall | SwapCallAsync)[]
  ...
  }, [account, chainId, provider, swapCallsMaybeAsync, trade])
}
